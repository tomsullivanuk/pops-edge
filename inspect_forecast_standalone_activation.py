...
def fixtures():
    ...
    market={"ticker":"KXMLB-20260905-AWYHME-HME","event_ticker":"KXMLB-20260905-AWYHME","title":"Away Club at Home Club winner?","yes_sub_title":"Home Club","no_sub_title":"Away Club","status":"open","open_time":"2026-09-04T00:00:00Z","close_time":"2026-09-05T10:00:00Z","expected_expiration_time":"2026-09-05T10:00:00Z","yes_bid_dollars":"0.4000","yes_ask_dollars":"0.7000","no_bid_dollars":"0.3000","no_ask_dollars":"0.6000","notional_value_dollars":"1.0000","rules_primary":"Pays $1 if Home Club wins."}
...
def run()->str:
    ...
    with tempfile.TemporaryDirectory() as temporary:
        ...
        initialized=execute("initialize-activation",config,clock=lambda:datetime(2026,8,28,tzinfo=timezone.utc));supporting=execute("refresh-supporting",config,clock=lambda:PRE,supporting_loader=lambda _at:(mlb,catalog,pages,(mlb,)))
